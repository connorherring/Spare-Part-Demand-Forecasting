## This script uses historical demand data for 17,000 spare parts to forecast short-term demand. Markov Chain transition probabilities and bootsrapping are used to deal with the intermittent naure of spare parts demand.
library(ggplot2)
library(reshape2)
library(sqldf)
library(foreach)
...
sample <- sample(unique(data1$Catalog_ID), 2000)
...
##for actual vs forecast comparison plot##
